...
public abstract class RedisObjectRepository<T> {
  ...
  public abstract void deleteByKey(@Nonnull T[] keyQueries);

  public abstract void deleteByKey(@Nonnull String keyString);

  public abstract void deleteByKey(@Nonnull String[] keyStrings);
  ...
  */
  ...
  public abstract List<T> getByKey(@Nonnull T[] keyQueries);

  public abstract T getByKey(@Nonnull String keyString);

  public abstract List<T> getByKey(@Nonnull String[] keyStrings);
